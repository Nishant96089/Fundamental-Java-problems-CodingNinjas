...
public class Solution {
    ...
    while(counter<element){
        ...
        for(int j=cStart;counter<element && j<=cEnd;j++)
        {
        ...
        rStart++;
        for(int i=rStart;counter<element && i<=rEnd;i++){
            System.out.print(matrix[i][cEnd]+" ");
            counter++;
        }
        cEnd--;
        for(int i=cEnd;counter<element && i>=cStart;i--)
        {
        ...
        rEnd--;
        for(int i=rEnd;counter<element && i>=rStart;i--)
        {
